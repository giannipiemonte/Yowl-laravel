            ...
            <div class="card p-3 mt-2">
                <div class="profile-comment">
                    <div class="picture">
                        ...
                        <img src="{{asset($item->user->avatar->thumb_url)}}" width="30"
                            class="user-img rounded-circle mr-2" alt="Photo de profil">
                        @else
                ...
                <div class="action d-flex justify-content-between mt-2 align-items-center">
                    <div class="reply px-4"><small>Reply </small><small> Translate</small> </div>
